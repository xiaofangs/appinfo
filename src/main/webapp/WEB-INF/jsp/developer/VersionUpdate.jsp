...
<body class="nav-md">
									...
									<div class="x_panel">
										...
										<div class="x_content">
											...
											<form id="demo-form2" data-parsley-validate=""
												...
												action="${pageContext.request.contextPath}/dev/appversion/update">
												${error}
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="text" id="first-name" required="required"
															...
															value="${app.versionNo}"> <input type="hidden"
												...
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														预发布 <input type="hidden" id="last-name"
															...
															class="form-control col-md-7 col-xs-12" value="3">
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12">
													...
													<div class="col-md-9 col-sm-9 col-xs-12">
														<textarea class="form-control" cols="3"
															...
															name="versionInfo">${app.versionInfo}</textarea>
													</div>
												</div>
												<div class="form-group">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/statics/js/VersionUpdate.js"></script>
	<!-- Bootstrap -->
	<script
